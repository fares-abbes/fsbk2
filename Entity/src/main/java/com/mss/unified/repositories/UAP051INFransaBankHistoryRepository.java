...
public interface UAP051INFransaBankHistoryRepository extends JpaRepository<UAP051INHistory, Integer>, JpaSpecificationExecutor<UAP051INHistory>{
	@Query("select A from UAP051INHistory A where A.accepted is null ")
	List<UAP051IN> getNotOk();
	
	@Query("select A from UAP051INHistory A where A.accepted ='1' ")
	List<UAP051IN> getListUAPINByStatusAccepted();
	
//	@Query("select A from UAP051INHistory A where A.accepted ='1' and A.fileDate=:fileDate")
	@Query("select A from UAP051INHistory A where A.fileDate=:fileDate")
	...
	Page<UAP051IN> filter(Pageable pageable, String typeTransaction, String typePaiement,
 	...
 	@Query("select A from UAP051INHistory A where A.numAutorisation =:numAutorisation and CONCAT(  A.codeBin  , A.typeCarte , A.numSeq,A.numOrdre , A.cle  )=:pan and A.flag='2' and motifRejet!='002' and A.numTransaction=:numTransaction")
	List<UAP051INHistory> findRejectedOnes(String numAutorisation,String pan,String numTransaction);
 	@Query("select A from UAP051INHistory A where A.numAutorisation =:numAutorisation and CONCAT(  A.codeBin  ,A.typeCarte , A.numSeq,A.numOrdre , A.cle )=:pan   and A.numTransaction=:numTransaction")
 	List<UAP051INHistory> findinHistorys(String numAutorisation,String pan,String numTransaction);
    List<UAP051INHistory> findByCopiedAndFlag(String copied,String flag); 
...
//	Page<UAP051INHistory> filterErWithStatus(Pageable pageable, String typeTransaction, String typePaiement, String numRIBcommercant,
//			String numContratAccepteur, String codeBin, String numTransaction, String dateTransactionS,
//			String dateTransactionE, String dateDebutValiditeCarteS, String dateDebutValiditeCarteE,
//			String dateFinValiditeCarteS, String dateFinValiditeCarteE, String dateRemiseS, String dateRemiseE,
//			String numAutorisation,String accepted);
	...
	@Query("SELECT u FROM UAP051INHistory u WHERE " + "(:typeTransaction IS NULL OR u.typeTransaction like %:typeTransaction%) "
	...
	Page<UAP051INHistory> filterErNotYetMatched(Pageable pageable,String typeTransaction, String typePaiement, String numRIBcommercant,
			String numContratAccepteur, String codeBin, String numTransaction, String dateTransactionS,
			String dateTransactionE, String dateDebutValiditeCarteS, String dateDebutValiditeCarteE,
			String dateFinValiditeCarteS, String dateFinValiditeCarteE, String dateRemiseS, String dateRemiseE,
			String numAutorisation);
	...
	@Query("SELECT u FROM UAP051INHistory u WHERE " + "(:typeTransaction IS NULL OR u.typeTransaction like %:typeTransaction%) "
			...
			+ "u.flag like :flag% ")
	Page<UAP051INHistory> filterErExtra(Pageable pageable,String typeTransaction, String typePaiement, String numRIBcommercant,
			String numContratAccepteur, String codeBin, String numTransaction, String dateTransactionS,
			String dateTransactionE, String dateDebutValiditeCarteS, String dateDebutValiditeCarteE,
			String dateFinValiditeCarteS, String dateFinValiditeCarteE, String dateRemiseS, String dateRemiseE,
	...
	@Query("SELECT u FROM UAP051INHistory u WHERE " + "(:typeTransaction IS NULL OR u.typeTransaction like %:typeTransaction%) "
			...
			+ "AND (:numAutorisation IS NULL OR u.numAutorisation like %:numAutorisation%) AND u.accepted='2' AND "
			+ "u.flag is null")
	Page<UAP051INHistory> filterErExtraWaiting(Pageable pageable,String typeTransaction, String typePaiement, String numRIBcommercant,
			String numContratAccepteur, String codeBin, String numTransaction, String dateTransactionS,
			String dateTransactionE, String dateDebutValiditeCarteS, String dateDebutValiditeCarteE,
			String dateFinValiditeCarteS, String dateFinValiditeCarteE, String dateRemiseS, String dateRemiseE,
			String numAutorisation);
