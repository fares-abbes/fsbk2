...
@Entity
@Table(schema = "ATM", name = "BATCH_ATM")
public class BatchAtm {

	@Id
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "BatchAtmSequence")
	@SequenceGenerator(name = "BatchAtmSequence", sequenceName = "PORTEUR.BatchAtmSequence", allocationSize = 1)
