...
@Entity
@Table(name = "BKMVTI_MP_FRANSABANKH", schema = "FRANSABANK")
public class BkmvtiMPFransaBankH {
	@Id
	...
	public String toString() {
		return "BkmvtiFransaBank [idbkm=" + idbkm + ", agence=" + agence + ", codeDevice=" + codeDevice
