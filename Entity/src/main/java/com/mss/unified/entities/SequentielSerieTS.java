...
@Entity
@Table(name = "Sequentiel_Serie_TS", schema = "POS")
public class SequentielSerieTS {
	@Id
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "SequentielSerieTSSequence")
	@SequenceGenerator(name = "SequentielSerieTSSequence", sequenceName = "POS.SequentielSerieTSSequence", allocationSize = 1)
