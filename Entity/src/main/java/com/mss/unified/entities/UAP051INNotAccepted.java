...
@Entity
@Table(name = "UAP051INNotAccepted", schema = "FRANSABANK")
public class UAP051INNotAccepted {
	 @Id
	@GeneratedValue(strategy = GenerationType.IDENTITY, generator = "UAP051INNotAcceptedSequence")
	@SequenceGenerator(name = "UAP051INNotAcceptedSequence", sequenceName = "FRANSABANK.UAP051INNotAcceptedSequence", allocationSize = 1)
	...
	public String toString() {
		return "UAP051INNotAccepted [code=" + code + ", typeTransaction=" + typeTransaction + ", codeBankAcquereur="
				...
				+ databaseMntCommission + ", controlId=" + controlId + "]";
	}
