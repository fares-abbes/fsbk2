...
@Entity
@Table(name = "ATM_SUPPLIES_STATUS",schema = "ATM")
public class AtmSuppliesStatus {
	 @Id
	    @Column(name = "ATE_ID", nullable = false)
	    private String atmSuppliesId;
	    ...
	    @Column(name = "CASHHANDLER_REJECT_BIN")
	    ...
	    public String getAtmSuppliesId() {
	        return atmSuppliesId;
	    }

	    public void setAtmSuppliesId(String atmSuppliesId) {
	        this.atmSuppliesId = atmSuppliesId;
	    }
