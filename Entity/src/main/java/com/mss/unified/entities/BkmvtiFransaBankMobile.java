...
@Entity
@Table(name = "BKMVTI_FRANSABANK_MOBILE", schema = "FRANSABANK")
public class BkmvtiFransaBankMobile {
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "idbkm", nullable = false)
	...
	private String numRefTransactions;
	
	
	public String getNumRefTransactions() {
		return numRefTransactions;
	}

	public void setNumRefTransactions(String numRefTransactions) {
		this.numRefTransactions = numRefTransactions;
	}

	public Long getIdbkm() {
		return idbkm;
	}

	public void setIdbkm(Long idbkm) {
		this.idbkm = idbkm;
	}
	...
	public String toString() {
		return "BkmvtiFransaBankMobile [idbkm=" + idbkm + ", agence=" + agence + ", codeDevice=" + codeDevice
				...
				+ ", numRefTransactions=" + numRefTransactions + "]";
	}
