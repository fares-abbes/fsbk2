...
@Entity
@Table(name = "UAP070FransaBankHistory", schema = "FRANSABANK")
public class UAP070FransaBankHistory {
	...
	private BigDecimal montantTranasction;;
	...
	public BigDecimal getMontantTranasction() {
	...
	public void setMontantTranasction(BigDecimal montantTranasction) {
