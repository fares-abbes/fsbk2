...
@Entity
@Table(name = "Sequentiel_Serie_TM", schema = "POS")
public class SequentielSerieTM {
	@Id
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "SequentielSerieTMSequence")
	@SequenceGenerator(name = "SequentielSerieTMSequence", sequenceName = "POS.SequentielSerieTMSequence", allocationSize = 1)
