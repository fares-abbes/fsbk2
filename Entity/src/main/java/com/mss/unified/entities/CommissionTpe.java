...
@Entity
@Table(schema = "POS",name = "COMMISSIONTPE")
public class CommissionTpe {
   /* @EmbeddedId
    @Column(name = "COMMISSION")
    private CommissionTpeId commissionTpeId;*/
	@Id
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "CommissionTpeSequence")
	@SequenceGenerator(name = "CommissionTpeSequence", sequenceName = "POS.CommissionTpeSequence", allocationSize = 1)
	...
	public String toString() {
		return "CommissionTpe [idCommission=" + idCommission + ", requestCode=" + requestCode + ", commissionNational="
				+ commissionNational + ", commissionInterNational=" + commissionInterNational + ", montantRefMin="
				+ montantRefMin + ", montantRefMax=" + montantRefMax + ", merchantCode=" + merchantCode
				+ ", operateurMin=" + operateurMin + ", operateurMax=" + operateurMax + ", valeurComFixMin="
				+ valeurComFixMin + ", valeurComFixMax=" + valeurComFixMax + ", valeurComVariableMin="
				+ valeurComVariableMin + ", valeurComVariableMax=" + valeurComVariableMax + ", label=" + label
				+ ", commissionType=" + commissionType + ", valeurCommissionNationaleFix="
