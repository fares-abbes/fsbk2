...
@Entity
@Table(name = "UAP050INHistory", schema = "FRANSABANK")
public class UAP050INHistory {
	
	
	  @Id
	@GeneratedValue(strategy = GenerationType.IDENTITY, generator = "newUAPFransaBank050INSequence")
	@SequenceGenerator(name = "newUAPFransaBank050INSequence", sequenceName = "FRANSABANK.UAPFransaBank050INSequencens", allocationSize = 1)
