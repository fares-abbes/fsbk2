...
@Entity
@Table(schema = "PORTEUR", name = "BATCH_PORTEUR")
public class BatchPorteur {
	@Id
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "BatchPorteurSequence")
	@SequenceGenerator(name = "BatchPorteurSequence", sequenceName = "PORTEUR.BatchPorteurSequence", allocationSize = 1)
