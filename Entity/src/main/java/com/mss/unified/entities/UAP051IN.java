...
@Entity
@Table(name = "UAP051IN", schema = "FRANSABANK")
public class UAP051IN {
	 @Id
	@GeneratedValue(strategy = GenerationType.IDENTITY, generator = "newUAPFransaBank051INSequence")
	@SequenceGenerator(name = "newUAPFransaBank051INSequence", sequenceName = "FRANSABANK.UAPFransaBank051INSequencens", allocationSize = 1)
	...
	public String toString() {
		return "UAP051IN [code=" + code + ", typeTransaction=" + typeTransaction + ", codeBankAcquereur="
