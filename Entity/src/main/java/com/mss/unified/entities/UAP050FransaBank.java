...
@Entity
@Table(name = "UAP050FransaBank", schema = "FRANSABANK")
public class UAP050FransaBank {
    @Id
	@GeneratedValue(strategy = GenerationType.IDENTITY, generator = "newUAPFransaBank050Sequence")
	@SequenceGenerator(name = "newUAPFransaBank050Sequence", sequenceName = "FRANSABANK.UAPFransaBank050Sequencens", allocationSize = 1)
