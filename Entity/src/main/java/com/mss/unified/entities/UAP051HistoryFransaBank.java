...
@Entity
@Table(name = "UAP051HistoryFransaBank", schema = "FRANSABANK")
public class UAP051HistoryFransaBank {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY, generator = "newUAPFransaBank051Sequence")
	@SequenceGenerator(name = "newUAPFransaBank051Sequence", sequenceName = "FRANSABANK.UAPFransaBank051Sequencens", allocationSize = 1)
	...
	public float getMontantCommissionConf() {
