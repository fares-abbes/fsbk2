...
@Entity
@Table(name = "ATM_SENS_STAT_MAP_ERR",schema = "ATM")
public class AtmSensorStatusMapError {
	@Id
	@Column(name = "ASSME_CODE", nullable = false)
	private String atmSensorErrorId;
	
	@Column(name = "SUPERVISOR_MODE")
