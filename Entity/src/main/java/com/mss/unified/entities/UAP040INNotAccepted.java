...
@Entity
@Table(name = "UAP040INNotAccepted", schema = "FRANSABANK")
public class UAP040INNotAccepted {
    @Id
	@GeneratedValue(strategy = GenerationType.IDENTITY, generator = "UAP040INNotAcceptedSequence")
	@SequenceGenerator(name = "UAP040INNotAcceptedSequence", sequenceName = "FRANSABANK.UAP040INNotAcceptedSequence", allocationSize = 1)
	...
	public String toString() {
		return "UAP040IN [code=" + code + ", typeTransaction=" + typeTransaction + ", typePaiement=" + typePaiement
				...
				+ montantRetrait + ", codeDebitPorteur=" + codeDebitPorteur + ", codeDebitCommercant="
				+ codeDebitCommercant + ", montantCommission=" + montantCommission + ", numTransaction="
				+ numTransaction + ", dateTransaction=" + dateTransaction + ", heureTransaction=" + heureTransaction
				+ ", identifSystem=" + identifSystem + ", identifPointRetrait=" + identifPointRetrait
				...
				+ atc + ", tvr=" + tvr + ", dateRemise=" + dateRemise + ", codeBankAcquereur=" + codeBankAcquereur
				+ ", codeAgence=" + codeAgence + ", typeRetrait=" + typeRetrait + ", typeCarteDebit=" + typeCarteDebit
				+ ", accepted=" + accepted + ", fileDate=" + fileDate + ", fileIntegrationDate=" + fileIntegrationDate
				+ ", fileMontantAcompenser=" + fileMontantAcompenser + ", fileMontantcommission="
				+ fileMontantcommission + ", flag=" + flag + ", done=" + done + ", dateReg=" + dateReg + ", motifRejet="
				+ motifRejet + ", rio=" + rio + ", compteDebit=" + compteDebit + ", compteCredit=" + compteCredit
				+ ", pieceComptableBKM=" + pieceComptableBKM + ", tagRetrait=" + tagRetrait + ", montantTransaction="
				+ montantTransaction + ", montantCommissionTTC=" + montantCommissionTTC + "]";
	}
