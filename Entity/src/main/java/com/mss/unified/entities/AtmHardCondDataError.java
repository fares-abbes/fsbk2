...
@Entity
@Table(name = "ATM_HARD_CONF_DATA_MAP_ERR",schema = "ATM")
public class AtmHardCondDataError {
    @Id
    ...
    @Column(name = "OPERATOR_KEYBORD")
    private String atmHardConfOperatorKeybord;

    @Column(name = "CARDHOLDER_DISPLAY")
