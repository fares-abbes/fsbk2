...
@Entity
@Table(schema = "POS",name = "COMMISSION_TPE_HISTORIQUE")
public class CommissionTpeHistorique {

	@Id
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "CommissionTpeHistoriqueSequence")
	@SequenceGenerator(name = "CommissionTpeHistoriqueSequence", sequenceName = "POS.CommissionTpeHistoriqueSequence", allocationSize = 1)
	...
	public String toString() {
		return "CommissionTpeHistorique [idCommission=" + idCommission + ", requestCode=" + requestCode
