...
@Entity
@Table(name = "UAP040FransaBankNotAccepted", schema = "FRANSABANK")
public class UAP040FransaBankNotAccepted {
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY, generator = "UAP040FransaBankNotAcceptedSequence")
	@SequenceGenerator(name = "UAP040FransaBankNotAcceptedSequence", sequenceName = "FRANSABANK.UAP040FransaBankNotAcceptedSequence", allocationSize = 1)
