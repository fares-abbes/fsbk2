...
@Entity
@Table(name = "AcsSummary",schema = "PORTEUR")
public class AcsSummary {
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "AcsSummarySequence")
    @SequenceGenerator(name = "AcsSummarySequence", sequenceName = "PORTEUR.AcsSummarySequence", allocationSize = 1)
