...
@Entity
@Table(name = "day_operation_card_fransaBank", schema = "FRANSABANK")
public class DayOperationCardFransaBank {
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY, generator = "newday_operation_card_fransaBank_sequence")
	@SequenceGenerator(name = "newday_operation_card_fransaBank_sequence", sequenceName = "FRANSABANK.day_operation_card_fransaBank_sequencens", allocationSize = 1)
