...
@Entity
@Table(name = "BKMVTI_CARD_FRANSABANK", schema = "FRANSABANK")
public class BkmvtiCardFransaBank {
    @Id
@GeneratedValue(strategy = GenerationType.IDENTITY, generator = "newBKMVTI_CARD_fransaBank_sequence")
    @SequenceGenerator(name = "newBKMVTI_CARD_fransaBank_sequence", sequenceName = "FRANSABANK.BKMVTI_CARD_fransaBank_sequencens", allocationSize = 1)
