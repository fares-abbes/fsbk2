...
@Entity
@Table(name = "ATM_HARD_FITNESS", schema = "ATM")
public class AtmHardFitness {

  @Id
  @Column(name = "ATE_ID", nullable = false)
  private String atmHardFitnessId;
  ...
  public String getAtmHardFitnessId() {
    return atmHardFitnessId;
  }

  public void setAtmHardFitnessId(String atmHardFitnessId) {
    this.atmHardFitnessId = atmHardFitnessId;
  }
  ...
  public String toString() {
    return "AtmHardFitness{" +
        "atmHardFitnessId='" + atmHardFitnessId + '\'' +
        ", atmHardFitnessTimeDay='" + atmHardFitnessTimeDay + '\'' +
        ", atmHardFitnessHighOrderCom='" + atmHardFitnessHighOrderCom + '\'' +
        ", atmHardFitnessSystemDisk='" + atmHardFitnessSystemDisk + '\'' +
        ", atmHardFitnessCardReader='" + atmHardFitnessCardReader + '\'' +
        ", atmHardFitnessCashHandler='" + atmHardFitnessCashHandler + '\'' +
        ", atmHardFitnessDepository='" + atmHardFitnessDepository + '\'' +
        ", atmHardFitnessReceiptPrinter='" + atmHardFitnessReceiptPrinter + '\'' +
        ", atmHardFitnessJournalPrinter='" + atmHardFitnessJournalPrinter + '\'' +
        ", atmHardFitnessPosition8='" + atmHardFitnessPosition8 + '\'' +
        ", atmHardFitnessPosition9='" + atmHardFitnessPosition9 + '\'' +
        ", atmHardFitnessNightSafeDeposit='" + atmHardFitnessNightSafeDeposit + '\'' +
        ", atmHardFitnessEncryptor='" + atmHardFitnessEncryptor + '\'' +
        ", atmHardFitnessSecurityCamera='" + atmHardFitnessSecurityCamera + '\'' +
        ", atmHardFitnessDoorAccess='" + atmHardFitnessDoorAccess + '\'' +
        ", atmHardFitnessFlexDisk='" + atmHardFitnessFlexDisk + '\'' +
        ", atmHardFitnessCassType1='" + atmHardFitnessCassType1 + '\'' +
        ", atmHardFitnessCassType2='" + atmHardFitnessCassType2 + '\'' +
        ", atmHardFitnessCassType3='" + atmHardFitnessCassType3 + '\'' +
        ", atmHardFitnessCassType4='" + atmHardFitnessCassType4 + '\'' +
        ", atmHardFitnessPosition19='" + atmHardFitnessPosition19 + '\'' +
        ", atmHardFitnessPosition20='" + atmHardFitnessPosition20 + '\'' +
        ", atmHardFitnessStatementPrinter='" + atmHardFitnessStatementPrinter + '\'' +
        ", atmHardFitnessSignageDisplay='" + atmHardFitnessSignageDisplay + '\'' +
        ", atmHardFitnessPosition23='" + atmHardFitnessPosition23 + '\'' +
        ", atmHardFitnessPosition24='" + atmHardFitnessPosition24 + '\'' +
        ", atmHardFitnessSystemDisplay='" + atmHardFitnessSystemDisplay + '\'' +
        ", atmHardFitnessMediaEntryIndi='" + atmHardFitnessMediaEntryIndi + '\'' +
        ", atmHardFitnessEnvelopeDispenser='" + atmHardFitnessEnvelopeDispenser + '\'' +
        ", atmHardFitnessDocProcModule='" + atmHardFitnessDocProcModule + '\'' +
        ", atmHardFitnessCoinDispModule='" + atmHardFitnessCoinDispModule + '\'' +
        ", atmHardFitnessDocModTamper='" + atmHardFitnessDocModTamper + '\'' +
        ", atmHardFitnessPosition31='" + atmHardFitnessPosition31 + '\'' +
        ", atmHardFitnessVoiceGuideSystem='" + atmHardFitnessVoiceGuideSystem + '\'' +
        ", atmHardFitnessPosition33='" + atmHardFitnessPosition33 + '\'' +
        ", atmHardFitnessBrunchNoteAcceptor='" + atmHardFitnessBrunchNoteAcceptor + '\'' +
        ", atmHardFitnessChequeProcessor='" + atmHardFitnessChequeProcessor + '\'' +
        ", atmHardFitnessBiometricCapture='" + atmHardFitnessBiometricCapture + '\'' +
        ", atmHardFitnessPosition37='" + atmHardFitnessPosition37 + '\'' +
        '}';
  }
}
