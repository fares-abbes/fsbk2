...
@Entity
@Table(name = "ChargebackVisa", schema = "FRANSABANK")
public class ChargebackVisa {
	@Id
	...
	private String vrolFinancialId;
	private String vrolCaseNumber;
	private String vrolBundleCaseNumber;
	...
	public String toString() {
		return "ChargebackVisa [code=" + code + ", transactionCode=" + transactionCode + ", treat=" + treat
				+ ", destinationBin=" + destinationBin + ", sourceBin=" + sourceBin + ", formatCode=" + formatCode
				+ ", constantIdentifier=" + constantIdentifier + ", reserved26=" + reserved26 + ", accountNumber="
				+ accountNumber + ", matchingCode=" + matchingCode + ", reserved4348=" + reserved4348 + ", reserved816="
				+ reserved816 + ", agentUniqueId=" + agentUniqueId + ", moneyTransferForeignExchangeFee="
				+ moneyTransferForeignExchangeFee + ", paymentAccountReference=" + paymentAccountReference
				+ ", tokenRequestorId=" + tokenRequestorId + ", spendQualifierIndicator=" + spendQualifierIndicator
				+ ", panToken=" + panToken + ", transactionIdentifier=" + transactionIdentifier
				+ ", numberOfPaymentForms=" + numberOfPaymentForms + ", summaryCode=" + summaryCode + ", reserved158="
				+ reserved158 + ", reserved4950=" + reserved4950 + ", tokenAssuranceLevel=" + tokenAssuranceLevel
				+ ", responseCode=" + responseCode + ", RESERVED5354=" + RESERVED5354 + ", transactionDate="
				+ transactionDate + ", reserved5960=" + reserved5960 + ", transactionTime=" + transactionTime
				+ ", reserved6566=" + reserved6566 + ", transactionAmount=" + transactionAmount + ", reserved7576="
				+ reserved7576 + ", inquiringCenter=" + inquiringCenter + ", reserved8182=" + reserved8182
				+ ", authorizationCode=" + authorizationCode + ", reserved8889=" + reserved8889
				+ ", baseTransactionCodeMerchantTerminalIndicator=" + baseTransactionCodeMerchantTerminalIndicator
				+ ", reserved9394=" + reserved9394 + ", standInReasonCode=" + standInReasonCode + ", reserved96100="
				+ reserved96100 + ", crisAlertType=" + crisAlertType + ", crisAlertScore=" + crisAlertScore
				+ ", networkIdentificationCode=" + networkIdentificationCode + ", reserved111167=" + reserved111167
				+ ", reimbursementAttribute=" + reimbursementAttribute + ", processingBin=" + processingBin
				+ ", processingDate=" + processingDate + ", settlementDate=" + settlementDate + ", releaseNumber="
				+ releaseNumber + ", reserved1429=" + reserved1429 + ", testOptional=" + testOptional
				+ ", reserved3462=" + reserved3462 + ", securityCode=" + securityCode + ", reserved7176=" + reserved7176
				+ ", outgoingFileId=" + outgoingFileId + ", reserved80168=" + reserved80168
				+ ", accountNumberExtension=" + accountNumberExtension + ", floorLimitIndicator=" + floorLimitIndicator
				+ ", crbExceptionFileIndicator=" + crbExceptionFileIndicator
				+ ", positiveCardholderAuthorisationServiceIndicator=" + positiveCardholderAuthorisationServiceIndicator
				+ ", acquirerReferenceNumber=" + acquirerReferenceNumber + ", acquirerBuisnessId=" + acquirerBuisnessId
				+ ", purchaseDate=" + purchaseDate + ", destinationAmount=" + destinationAmount
				...
				+ merchantCategoryCode + ", merchantZipCode=" + merchantZipCode + ", merchantStateCode="
				+ merchantStateCode + ", requestedPaymentService=" + requestedPaymentService + ", reserved146="
				+ reserved146 + ", usageCode=" + usageCode + ", reasonCode=" + reasonCode + ", settlementFlag="
				+ settlementFlag + ", authorisationCaracteristicsIndicator=" + authorisationCaracteristicsIndicator
				+ ", authorisationCode=" + authorisationCode + ", posTerminalCapability=" + posTerminalCapability
				+ ", internationalFeeIndicator=" + internationalFeeIndicator + ", cardholderId=" + cardholderId
				+ ", collectionOnlyFlag=" + collectionOnlyFlag + ", posEntryMode=" + posEntryMode
				+ ", centralProcessingDate=" + centralProcessingDate + ", businessFormatCode=" + businessFormatCode
				+ ", dataContent=" + dataContent + ", reserved516=" + reserved516 + ", debitProductCode="
				+ debitProductCode + ", contactForInfo=" + contactForInfo + ", adjustmentProcessingIndicator="
				+ adjustmentProcessingIndicator + ", messageReasonCode=" + messageReasonCode + ", surchargeAmount="
				+ surchargeAmount + ", surchargeCreditOrDebitIndicator=" + surchargeCreditOrDebitIndicator
				+ ", visaInternalUseOnly=" + visaInternalUseOnly + ", BUSINESS_FORMAT_CODE_03="
				+ BUSINESS_FORMAT_CODE_03 + ", BUSINESS_FORMAT_CODE_04=" + BUSINESS_FORMAT_CODE_04 + ", reserved77103="
				+ reserved77103 + ", surchargeAmountCardholderBillingCurrency="
				+ surchargeAmountCardholderBillingCurrency + ", reserved112168=" + reserved112168
				+ ", authorizedAmount=" + authorizedAmount + ", authorizationCurrencyCode=" + authorizationCurrencyCode
				+ ", authorizationResponseCode=" + authorizationResponseCode + ", validationCode=" + validationCode
				+ ", excludedTransactionIdentifier=" + excludedTransactionIdentifier + ", crsProcessingCode="
				+ crsProcessingCode + ", chargeBackRightsIndicator=" + chargeBackRightsIndicator
				+ ", multipleClearingSequenceNumber=" + multipleClearingSequenceNumber
				+ ", multipleClearingSequenceCount=" + multipleClearingSequenceCount + ", cardHolderIdMethod="
				+ cardHolderIdMethod + ", marketSpecificAuthorizationDataIndicator="
				+ marketSpecificAuthorizationDataIndicator + ", totalAuthorizedAmount=" + totalAuthorizedAmount
				+ ", informationIndicator=" + informationIndicator + ", merchantTelephoneNumber="
				+ merchantTelephoneNumber + ", additionalDataIndicator=" + additionalDataIndicator
				+ ", merchantVolumeIndicator=" + merchantVolumeIndicator + ", electronicCommerceGoodsIndicator="
				+ electronicCommerceGoodsIndicator + ", merchantVerificationValue=" + merchantVerificationValue
				+ ", acceptanceTerminalIndicator=" + acceptanceTerminalIndicator + ", interchangeFeeAmount="
				+ interchangeFeeAmount + ", interchangeFeeSign=" + interchangeFeeSign
				...
				+ ", optionalIsaAmount=" + optionalIsaAmount + ", productId=" + productId + ", programID=" + programID
				+ ", dynamicCurrencyConversionIndicator=" + dynamicCurrencyConversionIndicator
				+ ", accountTypeIdentification=" + accountTypeIdentification + ", reserved149167=" + reserved149167
				+ ", cvv2ResultCode=" + cvv2ResultCode + ", localTax=" + localTax + ", localTaxIncluded="
				+ localTaxIncluded + ", nationalTax=" + nationalTax + ", nationalTaxIncluded=" + nationalTaxIncluded
				+ ", merchantVatRegistrationBusinessReferenceNumber=" + merchantVatRegistrationBusinessReferenceNumber
				+ ", customerVatRegistrationNumber=" + customerVatRegistrationNumber + ", reserved6475=" + reserved6475
				+ ", summaryCommodityCode=" + summaryCommodityCode + ", otherTax=" + otherTax + ", messageIdentifier="
				+ messageIdentifier + ", timeOfPurchase=" + timeOfPurchase + ", cri=" + cri + ", nonFuelProductCode1="
				+ nonFuelProductCode1 + ", nonFuelProductCode2=" + nonFuelProductCode2 + ", nonFuelProductCode3="
				+ nonFuelProductCode3 + ", nonFuelProductCode4=" + nonFuelProductCode4 + ", nonFuelProductCode5="
				+ nonFuelProductCode5 + ", nonFuelProductCode6=" + nonFuelProductCode6 + ", nonFuelProductCode7="
				+ nonFuelProductCode7 + ", nonFuelProductCode8=" + nonFuelProductCode8 + ", merchantPostalCode="
				+ merchantPostalCode + ", reserved155168=" + reserved155168 + ", cardSequenceNumber="
				+ cardSequenceNumber + ", terminalTransactionDate=" + terminalTransactionDate + ", terminalCapability="
				+ terminalCapability + ", terminalCountryCode=" + terminalCountryCode + ", terminalSerialNumber="
				+ terminalSerialNumber + ", unpredictableNumber=" + unpredictableNumber
				+ ", applicationTransactionCounter=" + applicationTransactionCounter
				+ ", applicationInterchangeProfile=" + applicationInterchangeProfile + ", cryptogram=" + cryptogram
				+ ", issuerApplicationDataByte2=" + issuerApplicationDataByte2 + ", issuerApplicationDataByte3="
				+ issuerApplicationDataByte3 + ", terminalVerificationResults=" + terminalVerificationResults
				+ ", issuerApplicationDataByte47=" + issuerApplicationDataByte47 + ", cryptogramAmount="
				+ cryptogramAmount + ", issuerApplicationDataByte8=" + issuerApplicationDataByte8
				+ ", issuerApplicationDataByte916=" + issuerApplicationDataByte916 + ", issuerApplicationDataByte1="
				+ issuerApplicationDataByte1 + ", issuerApplicationDataByte17=" + issuerApplicationDataByte17
				+ ", issuerApplicationDataByte1832=" + issuerApplicationDataByte1832 + ", formFactorIndicator="
				+ formFactorIndicator + ", issuerScript1Results=" + issuerScript1Results + ", issuerWorkstationBin="
				+ issuerWorkstationBin + ", acquirerWorkstationBin=" + acquirerWorkstationBin + ", chargeBacKNumber="
				+ chargeBacKNumber + ", documentationIndicator=" + documentationIndicator + ", issuerCharge="
				+ issuerCharge + ", reserved80=" + reserved80 + ", cardAcceptorId=" + cardAcceptorId + ", terminalId="
				+ terminalId + ", nationalReimbursementFee=" + nationalReimbursementFee
				+ ", mailPhoneElectronicCommerceAndPaymentIndicator=" + mailPhoneElectronicCommerceAndPaymentIndicator
				+ ", specialChargeBackIndicator=" + specialChargeBackIndicator + ", interfaceTraceNumber="
				+ interfaceTraceNumber + ", unattentedTraceNumber=" + unattentedTraceNumber
				+ ", authorizationSourceCode=" + authorizationSourceCode + ", prepaidCardIndicator="
				+ prepaidCardIndicator + ", serviceDevelopmentField=" + serviceDevelopmentField + ", avsResponseCode="
				+ avsResponseCode + ", purchaseIdentifierFormat=" + purchaseIdentifierFormat + ", accountSelection="
				+ accountSelection + ", installmentPaymentCount=" + installmentPaymentCount + ", purchaseIdentifier="
				+ purchaseIdentifier + ", cashBack=" + cashBack + ", chipConditionCode=" + chipConditionCode
				+ ", posEnvironment=" + posEnvironment + ", reserved514=" + reserved514 + ", transactionType="
				+ transactionType + ", memberMessageText=" + memberMessageText + ", specialConditionIndicator="
				+ specialConditionIndicator + ", feeProgramIndicator=" + feeProgramIndicator + ", baseCurrency="
				+ baseCurrency + ", baseAmount=" + baseAmount + ", constatation=" + constatation + ", statusChargeback="
				+ statusChargeback + ", messageReject=" + messageReject + "]";
	}
	...
	public void visaIncomingSetter(String visa, int summary,double baseCurrencyToDestinationCurrencyExchangeRate) {//, String baseCurrency
		this.summaryCode= summary;
		switch(visa.substring(2, 4)) {
		case "00":
		...
		case "03":
			...
			case "04":
				...
				this.vrolFinancialId = visa.substring(53, 64);
				this.vrolCaseNumber = visa.substring(64, 74);
				this.vrolBundleCaseNumber = visa.substring(74, 84);
		...
		baseCurrency=this.destinationCurrencyCode;
		this.baseAmount= Math.round(this.destinationAmount * 100.0) / 100.0;
	
		/*if(this.sourceCurrencyCode!=null && Arrays.asList("978").contains(this.sourceCurrencyCode) && "840".equals( this.destinationCurrencyCode) ){//,"840"
			baseCurrency=this.destinationCurrencyCode;//978
			this.baseAmount= Math.round(this.destinationAmount * 100.0) / 100.0;
		...
		}else if(this.sourceCurrencyCode!=null && Arrays.asList("978").contains(this.sourceCurrencyCode)) {//,"840"
			baseCurrency=this.sourceCurrencyCode;//978
			this.baseAmount= Math.round(sourceAmount * 100.0) / 100.0;
			this.interchangeFeeAmount= Math.round(interchangeFeeAmount*sourceCurrencyToBaseCurrencyExchangeRate*Math.pow(10, 6))/Math.pow(10, 6);
			
			this.baseCurrencyToDestinationCurrencyExchangeRate= Math.round(sourceAmount/destinationAmount*Math.pow(10, 6))/Math.pow(10, 6);

		}else if (this.sourceCurrencyCode!=null && Arrays.asList("840").contains(this.sourceCurrencyCode)){
			baseCurrency=this.sourceCurrencyCode;
			this.baseAmount= Math.round(sourceAmount * 100.0) / 100.0;

		}else {
			baseCurrency="840";
			this.baseAmount= Math.round(destinationAmount*this.baseCurrencyToDestinationCurrencyExchangeRate * 100.0) / 100.0;
	...
	public void setPositiveCardholderAuthorisationServiceIndicator(String positiveCardholderAuthorisationServiceIndicator) {
	...
	public void setBUSINESS_FORMAT_CODE_03(String bUSINESS_FORMAT_CODE_03) {
		BUSINESS_FORMAT_CODE_03 = bUSINESS_FORMAT_CODE_03;
	}
	...
	public void setBUSINESS_FORMAT_CODE_04(String bUSINESS_FORMAT_CODE_04) {
		BUSINESS_FORMAT_CODE_04 = bUSINESS_FORMAT_CODE_04;
	}
	...
	public void setMerchantVatRegistrationBusinessReferenceNumber(String merchantVatRegistrationBusinessReferenceNumber) {
	...
	public String getReserved117168() {
		return reserved117168;
	}

	public void setReserved117168(String reserved117168) {
		this.reserved117168 = reserved117168;
	}
}
