...
@Table(name = "day_operation_fransaBank", schema = "FRANSABANK")

public class DayOperationFransaBank {
	@Id
	...
	public String toString() {
		return "DayOperationFransaBank [iddays=" + iddays + ", codeBank=" + codeBank + ", numRIBEmetteur="
