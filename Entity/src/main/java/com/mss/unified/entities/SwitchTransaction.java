...
@Entity
@Table(name = "SWITCH",schema="SWITCH")
...
public class SwitchTransaction  {
	...
	@Column(name = "DE48_ADDITIONAL_DATA", length = 4000)
	...
	@Column(name = "DE54_ADDITONAL_AMOUNT", length = 4000)
	private String switchAdditionalAmount;
	
	@Column(name = "DE55_EMV_DATA" , length = 4000)
