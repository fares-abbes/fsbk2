...
@Entity
@Table(name = "UAP051INRHistory", schema = "FRANSABANK")
public class UAP051INRHistory {
	@Id
	...
	public String toString() {
		return "UAP051INRHistory [code=" + code + ", typeTransaction=" + typeTransaction + ", typePaiement="
				+ typePaiement + ", referenceArchivage=" + referenceArchivage + ", indicateur=" + indicateur
				+ ", numRIBcommercant=" + numRIBcommercant + ", prefixeIBAN=" + prefixeIBAN + ", libelleCommercant="
				+ libelleCommercant + ", adresseCommercant=" + adresseCommercant + ", telephoneCommercant="
				+ telephoneCommercant + ", numContratAccepteur=" + numContratAccepteur + ", codeActivite="
				+ codeActivite + ", reserved=" + reserved + ", codeBin=" + codeBin + ", typeCarte=" + typeCarte
				...
				+ fileDate + ", codeBankAcquereur=" + codeBankAcquereur + ", fileIntegrationDate=" + fileIntegrationDate
				+ ", done=" + done + ", dateReglement=" + dateReglement + ", motifRejet=" + motifRejet + ", rio=" + rio
				+ ", flag=" + flag + ", copied=" + copied + ", databaseMntACompenser=" + databaseMntACompenser
				+ ", databaseMntCommission=" + databaseMntCommission + ", montantTransaction=" + montantTransaction
				+ ", montantCommissionFSBKTTC=" + montantCommissionFSBKTTC + ", bkmGeneration=" + bkmGeneration + "]";
	}
