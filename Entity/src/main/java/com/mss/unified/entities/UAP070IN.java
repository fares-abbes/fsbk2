...
@Entity
@Table(name = "UAP070IN", schema = "FRANSABANK")
public class UAP070IN implements TransactionEntity {
	@Id
	...
	private BigDecimal montantCompensee;
	private String origin;
	private String numRefArchivage;
	private String idPlateformeMobileBeneficiaire;
	private String idPlateformeMobileDonneur;
	private BigDecimal fileTransactionAmount;
	private BigDecimal fileCompensationAmount;

	private BigDecimal fileCommissionAmount;
	...
	public BigDecimal getFileTransactionAmount() {
		return fileTransactionAmount;
	}

	public void setFileTransactionAmount(BigDecimal fileTransactionAmount) {
		this.fileTransactionAmount = fileTransactionAmount;
	}

	public BigDecimal getFileCompensationAmount() {
		return fileCompensationAmount;
	}

	public void setFileCompensationAmount(BigDecimal fileCompensationAmount) {
		this.fileCompensationAmount = fileCompensationAmount;
	}

	public BigDecimal getFileCommissionAmount() {
		return fileCommissionAmount;
	}

	public void setFileCommissionAmount(BigDecimal fileCommissionAmount) {
		this.fileCommissionAmount = fileCommissionAmount;
	}

	public BigDecimal getMontantCompensee() {
		return montantCompensee;
	}

	public void setMontantCompensee(BigDecimal montantCompensee) {
		this.montantCompensee = montantCompensee;
	}
}
