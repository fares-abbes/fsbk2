...
@Entity
@Table(name = "UAP051INR", schema = "FRANSABANK")
public class UAP051INR {
	 @Id
	...
	private int montantCommissionFSBKTTC;
	...
	public int getMontantCommissionFSBKTTC() {
		return montantCommissionFSBKTTC;
	}

	public void setMontantCommissionFSBKTTC(int montantCommissionFSBKTTC) {
		this.montantCommissionFSBKTTC = montantCommissionFSBKTTC;
	}
	...
	public String toString() {
		return "UAP051INR [code=" + code + ", typeTransaction=" + typeTransaction + ", codeBankAcquereur="
				+ codeBankAcquereur + ", typePaiement=" + typePaiement + ", referenceArchivage=" + referenceArchivage
				+ ", indicateur=" + indicateur + ", numRIBcommercant=" + numRIBcommercant + ", prefixeIBAN="
				+ prefixeIBAN + ", libelleCommercant=" + libelleCommercant + ", adresseCommercant=" + adresseCommercant
				+ ", telephoneCommercant=" + telephoneCommercant + ", numContratAccepteur=" + numContratAccepteur
				+ ", codeActivite=" + codeActivite + ", reserved=" + reserved + ", codeBin=" + codeBin + ", typeCarte="
				+ typeCarte + ", numSeq=" + numSeq + ", numOrdre=" + numOrdre + ", cle=" + cle + ", montantAComponser="
				...
				+ atc + ", tvr=" + tvr + ", dateRemise=" + dateRemise + ", accepted=" + accepted + ", fileDate="
				+ fileDate + ", fileIntegrationDate=" + fileIntegrationDate + ", fileMontantAcompenser="
				+ fileMontantAcompenser + ", fileMontantcommission=" + fileMontantcommission + ", flag=" + flag
				+ ", done=" + done + ", rio=" + rio + ", motifRejet=" + motifRejet + ", pieceComptableBKM="
				+ pieceComptableBKM + ", codeAgence=" + codeAgence + ", tagPaiement=" + tagPaiement + ", dateReglement="
				+ dateReglement + ", montantTransaction=" + montantTransaction + ", montantCommissionFSBKTTC="
				+ montantCommissionFSBKTTC + ", bkmGeneration=" + bkmGeneration + ", copied=" + copied
				+ ", databaseMntACompenser=" + databaseMntACompenser + ", databaseMntCommission="
				+ databaseMntCommission + ", getDatabaseMntACompenser()=" + getDatabaseMntACompenser()
				+ ", getDatabaseMntCommission()=" + getDatabaseMntCommission() + ", getCopied()=" + getCopied()
				+ ", getBkmGeneration()=" + getBkmGeneration() + ", getMontantTransaction()=" + getMontantTransaction()
				+ ", getMontantCommissionFSBKTTC()=" + getMontantCommissionFSBKTTC() + ", getDateReglement()="
				+ getDateReglement() + ", getTagPaiement()=" + getTagPaiement() + ", getPieceComptableBKM()="
				+ getPieceComptableBKM() + ", getCodeAgence()=" + getCodeAgence() + ", getDone()=" + getDone()
				+ ", getFlag()=" + getFlag() + ", getFileMontantAcompenser()=" + getFileMontantAcompenser()
				+ ", getFileMontantcommission()=" + getFileMontantcommission() + ", getCode()=" + getCode()
				+ ", getTypeTransaction()=" + getTypeTransaction() + ", getTypePaiement()=" + getTypePaiement()
				+ ", getReferenceArchivage()=" + getReferenceArchivage() + ", getIndicateur()=" + getIndicateur()
				+ ", getNumRIBcommercant()=" + getNumRIBcommercant() + ", getPrefixeIBAN()=" + getPrefixeIBAN()
				+ ", getLibelleCommercant()=" + getLibelleCommercant() + ", getAdresseCommercant()="
				+ getAdresseCommercant() + ", getTelephoneCommercant()=" + getTelephoneCommercant()
				+ ", getNumContratAccepteur()=" + getNumContratAccepteur() + ", getCodeActivite()=" + getCodeActivite()
				+ ", getReserved()=" + getReserved() + ", getCodeBin()=" + getCodeBin() + ", getTypeCarte()="
				+ getTypeCarte() + ", getNumSeq()=" + getNumSeq() + ", getNumOrdre()=" + getNumOrdre() + ", getCle()="
				+ getCle() + ", getMontantAComponser()=" + getMontantAComponser() + ", getMontantRetrait()="
				+ getMontantRetrait() + ", getCodeDebitPorteur()=" + getCodeDebitPorteur()
				+ ", getCodeDebitCommercant()=" + getCodeDebitCommercant() + ", getMontantCommission()="
				+ getMontantCommission() + ", getNumTransaction()=" + getNumTransaction() + ", getDateTransaction()="
				+ getDateTransaction() + ", getHeureTransaction()=" + getHeureTransaction() + ", getIdentifSystem()="
				+ getIdentifSystem() + ", getIdentifPointRetrait()=" + getIdentifPointRetrait()
				+ ", getModeLectureCarte()=" + getModeLectureCarte() + ", getMethAuthPorteur()=" + getMethAuthPorteur()
				+ ", getNumAutorisation()=" + getNumAutorisation() + ", getDateDebutValiditeCarte()="
				+ getDateDebutValiditeCarte() + ", getDateFinValiditeCarte()=" + getDateFinValiditeCarte()
				+ ", getCryptogramData()=" + getCryptogramData() + ", getAtc()=" + getAtc() + ", getTvr()=" + getTvr()
				+ ", getDateRemise()=" + getDateRemise() + ", getAccepted()=" + getAccepted() + ", getFileDate()="
				+ getFileDate() + ", getFileIntegrationDate()=" + getFileIntegrationDate() + ", getRio()=" + getRio()
				+ ", getMotifRejet()=" + getMotifRejet() + ", getCodeBankAcquereur()=" + getCodeBankAcquereur()
