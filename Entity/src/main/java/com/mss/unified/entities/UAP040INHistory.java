...
@Entity
@Table(name = "UAP040INHistory", schema = "FRANSABANK")
public class UAP040INHistory {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY, generator = "newUAPFransaBank040INSequence")
	@SequenceGenerator(name = "newUAPFransaBank040INSequence", sequenceName = "FRANSABANK.UAPFransaBank040INSequencens", allocationSize = 1)
