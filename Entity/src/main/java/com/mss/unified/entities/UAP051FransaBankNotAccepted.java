...
@Entity
@Table(name = "UAP051FransaBankNotAccepted", schema = "FRANSABANK")
public class UAP051FransaBankNotAccepted {
	
    @Id
	@GeneratedValue(strategy = GenerationType.IDENTITY, generator = "UAP051FransaBankNotAcceptedSequence")
	@SequenceGenerator(name = "UAP051FransaBankNotAcceptedSequence", sequenceName = "FRANSABANK.UAP051FransaBankNotAcceptedSequence", allocationSize = 1)
