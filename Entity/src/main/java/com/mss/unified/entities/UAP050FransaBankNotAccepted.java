...
@Entity
@Table(name = "UAP050FransaBankNotAccepted", schema = "FRANSABANK")
public class UAP050FransaBankNotAccepted {
    @Id
	@GeneratedValue(strategy = GenerationType.IDENTITY, generator = "UAP050FransaBankNotAcceptedSequence")
	@SequenceGenerator(name = "UAP050FransaBankNotAcceptedSequence", sequenceName = "FRANSABANK.UAP050FransaBankNotAcceptedSequence", allocationSize = 1)
