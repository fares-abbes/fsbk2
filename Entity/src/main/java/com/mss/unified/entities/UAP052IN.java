...
@Entity
@Table(name = "UAP052IN", schema = "FRANSABANK")
public class UAP052IN implements TransactionNational {
	@Id
	...
	public String toString() {
		return "UAP050IN [code=" + code + ", typeTransaction=" + typeTransaction + ", typePaiement=" + typePaiement
				...
				+ montantRetrait + ", rio=" + uapRio + ", codeBankAcquereur=" + codeBankAcquereur + ", codeDebitPorteur="
