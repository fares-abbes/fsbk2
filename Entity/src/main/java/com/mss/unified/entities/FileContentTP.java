...
private BatchesHistory batchHistory;
    ...
    private String typeDispositifSansContract;  // length 1

    // Commission gestionnaire ATM
    private String commissionsGestionaireATM;   // length 12

    // Bloc A (Retrait)
    private String localisationATM;             // length 40
    private String reseau;                      // length 10
    private String rufRetrait;                  // length 8

    // New status field
    @Column(name = "status")
    private String status;

    // Getters and setters (similar to FileContentT)
    ...
    public String getNumAutorisationInitial() {
    ...
    public String getdateOPInitial() {
    ...
    public String getMethodeVerificationPorteur() {
        return methodeVerificationPorteur;
    }

    public void setMethodeVerificationPorteur(String methodeVerificationPorteur) {
        this.methodeVerificationPorteur = methodeVerificationPorteur;
    }

    public String getTypeDispositifSansContract() {
        return typeDispositifSansContract;
    }

    public void setTypeDispositifSansContract(String typeDispositifSansContract) {
        this.typeDispositifSansContract = typeDispositifSansContract;
    }
    ...
    public String getLocalisationATM() {
        return localisationATM;
    }

    public void setLocalisationATM(String localisationATM) {
        this.localisationATM = localisationATM;
    }
    ...
    public String getRufRetrait() {
        return rufRetrait;
    }

    public void setRufRetrait(String rufRetrait) {
        this.rufRetrait = rufRetrait;
    }
    ...
    public String toString() {
        return "FileContentTP [id=" + id + ", codeDebit=" + codeDebit + ", codeBin=" + codeBin + ", codeBank=" + codeBank
                + ", numRIBEmetteur=" + numRIBEmetteur + ", numCartePorteur=" + numCartePorteur
                + ", codeDebitCommercant=" + codeDebitCommercant + ", numRIBcommercant=" + numRIBcommercant
                + ", BinAcquereur=" + BinAcquereur + ", CodeBankAcquereur=" + CodeBankAcquereur + ", CodeAgence="
                + CodeAgence + ", idTerminal=" + idTerminal + ", idCommercant=" + idCommercant + ", typeTransaction="
                + typeTransaction + ", dateTransaction=" + dateTransaction + ", heureTransaction=" + heureTransaction
                + ", montantTransaction=" + montantTransaction + ", numFacture=" + numFacture + ", emetteurFacture="
                + emetteurFacture + ", numRefTransaction=" + numRefTransaction + ", numAutorisation=" + numAutorisation
                + ", codeDebitPorteur=" + codeDebitPorteur + ", commisionPorteur=" + commisionPorteur
                + ", codeDebitCommisionCommercant=" + codeDebitCommisionCommercant + ", commisionCommercant="
                + commisionCommercant + ", commisionInterchange=" + commisionInterchange
                + ", fraisOperateurTechnique=" + fraisOperateurTechnique + ", appCryptogram=" + appCryptogram
                + ", cryptogramInfoData=" + cryptogramInfoData + ", atc=" + atc + ", terminalVerificationResult="
