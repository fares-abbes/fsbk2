...
@Entity
@Table(name = "Sequentiel_Serie_BM", schema = "POS")
public class SequentielSerieBM {

	@Id
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "SequentielSerieBMSequence")
	@SequenceGenerator(name = "SequentielSerieBMSequence", sequenceName = "POS.SequentielSerieBMSequence", allocationSize = 1)
