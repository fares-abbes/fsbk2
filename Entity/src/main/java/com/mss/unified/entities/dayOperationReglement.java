...
@Entity
@Table(name = "day_operation_reglement", schema = "FRANSABANK")
public class dayOperationReglement {
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY, generator = "newday_operation_fransaBank_sequence")
	@SequenceGenerator(name = "newday_operation_fransaBank_sequence", sequenceName = "FRANSABANK.day_operation_fransaBank_sequencens", allocationSize = 1)
