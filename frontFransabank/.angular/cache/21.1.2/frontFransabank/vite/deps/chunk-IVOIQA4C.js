...
function A(t, n) {
  ...
  }, [m, i] = o(v2), [M, f] = o(E), r = Math.max(...i.map((l, c) => l + m[c])), u = Math.max(...f.map((l, c) => l + M[c])), a, s3 = 0, d = 0;
...
function tt(t, n) {
  ...
  let e = {}, o = false, m = {}, i = null, M = {}, f = (a) => {
    ...
    return S2(t, e.autoHeight, e.autoWidth), s3 == null || s3(h), W(t, g), W(t, y), t.offsetHeight, P(t, g), W(t, P2), d == null || d(h), new Promise((b2) => {
...
var DatePicker = class _DatePicker extends BaseInput {
  ...
  isYearDisabled(year) {
    return Array(12).fill(0).every((v3, month) => this.isMonthDisabled(month, year));
  }
  isYearSelected(year) {
  ...
  isValidSelection(value) {
    ...
    let isValid = value.every((v3) => this.isSelectable(v3.getDate(), v3.getMonth(), v3.getFullYear(), false));
...
//# sourceMappingURL=chunk-IVOIQA4C.js.map
